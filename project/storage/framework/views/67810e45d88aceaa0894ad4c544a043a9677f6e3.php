			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="user-comment">
						...
						<hr/>
					<form action="/home/per_comment"method="post">
						<?php echo e(csrf_field()); ?>

						<!-- <?php echo e(method_field('')); ?> -->
						<input type="hidden" value="<?php echo e($data->lid); ?>" name="lid">
						<input type="hidden" value="<?php echo e($data->gid); ?>" name="gid">
						<input type="hidden" value="<?php echo e($data->uid); ?>" name="uid">
								...
								<div class="item-title">
									...
									<div class="item-info">
										...
										<div class="item-price">
											价格：<strong><?php echo e($data->price); ?></strong>
										</div>										
									</div>
								</div>
								<div class="clear"></div>
								<div class="item-comment" name="content">
									<textarea placeholder="请写下对宝贝的感受吧，对他人帮助很大哦！" name="content"></textarea>
								</div>
								
								<div class="item-opinion">
									<input type="radio" name="type" value="1">好评&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="radio" name="type" value="0">中评&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="radio" name="type" value="-1">差评
