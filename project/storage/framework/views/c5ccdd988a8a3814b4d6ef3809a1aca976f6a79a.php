...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <title><?php echo e($list_config->title); ?></title>
        <meta name="keywords" content="<?php echo e($list_config->key); ?>">
        <meta name="description" content="<?php echo e($list_config->desn); ?>">
        ...
        <!-- <div class="hmtop"> -->
            ...
            <div class="am-container header">
                <ul class="message-l">
                    <div class="topMessage">
                        <div class="menu-hd">
                            <a href="#" target="_top" class="h">欢迎您，亲爱的<?php echo e($users->name); ?></a>|&nbsp;
            ...
            <ul class="message-r">
                    ...
                    <div class="topMessage mini-cart">
                        <div class="menu-hd"><a id="mc-menu-hd" href="/home/shopcart" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h"><?php echo e(count(session('c'))/7); ?></strong></a></div>
                    </div>
                ...
                <div class="nav white" style='display:-99999;'>
                    ...
                    <div class="logoBig">
                        ...
                        <li><img src="/admin/upload/<?php echo e($list_config->logo); ?>" /></li>
            ...
            <div class="footer ">
                        <div class="footer-hd ">
                            ...
                            <p><?php $__currentLoopData = $list_friends; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e($v->url); ?>"><?php echo e($v->name); ?>  　　</a>
                    ...
                    <!-- <div class="footer"> -->
                        <div class="footer-bd ">
                            <p>
                                <em><?php echo e($list_config->copyright); ?></em>
                            </p>
            ...
            <div id="sidebar">
                <div id="wrap">
                    ...
                    <div id="shopCart " class="item ">
                        ...
                        <p class="cart_num "><?php echo e(count(session('c'))/7); ?></p>
                    </div>
