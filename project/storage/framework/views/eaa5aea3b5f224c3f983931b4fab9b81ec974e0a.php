					...
					<form class="am-form am-form-horizontal" method="post"action="/home/per_safety/<?php echo e(session('users')->uid); ?>">
						...
						<div class="am-form-group bind">
							...
							<div class="am-form-content">
								<span name="name"><?php echo e(session('users')->name); ?></span>
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-name" class="am-form-label">真实姓名</label>
							<div class="am-form-content">
								<input type="text" name="realname" placeholder="请输入您的真实姓名" value="<?php echo e($ob->realname); ?>"<?php if($ob->idnum): ?>disabled <?php endif; ?>>
							</div>
						</div>
						<div class="am-form-group">
							<label for="idnum" class="am-form-label">身份证号</label>
							<div class="am-form-content">
								<input type="tel" name="idnum" placeholder="请输入您的身份证信息" value="<?php echo e($ob->idnum); ?>" <?php if($ob->idnum): ?>disabled <?php endif; ?>>
							</div>
						</div>
						<div class="info-btn">
