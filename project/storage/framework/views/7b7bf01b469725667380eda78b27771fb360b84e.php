...
<!-- 								<li class="select-list">
								...
								<li class="select-list">
									<dl id="select2">
										...
										<div class="dd-conent">
											<dd class="select-all selected"><a href="<?php echo e($parent); ?>">上级</a></dd>
											<?php $__currentLoopData = $son; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<dd><a href="<?php echo e($path); ?>,<?php echo e($v->cid); ?>"><?php echo e($v->name); ?></a></dd>
...
<!-- 								<li class="select-list">
							...
							<div class="search-side">
								...
								<li>
									<div class="i-pic check"><a href="/home/goods/<?php echo e($v->gid); ?>">
										<img src="/Admin/upload/<?php echo e($v->showpic); ?>" />
