<?php $__env->startSection('content'); ?>
    <div class="block-area" id="tableHover">
        ...
        <div class="table-responsive overflow">
            <form action='/admin/book_lists_f' method='post' name='myform'>
            ...
            <form action='/admin/book_lists_f/<?php echo e($state); ?>' method='get'>
                ...
                <tbody>
                    <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-alt m-r-5" href='javascript:doqr(<?php echo e($v->lid); ?>)'>发货</a>
                            </td>
                        </tr>
    ...
    <script type="text/javascript">
        function doqr(id){
            if(confirm('确定发货吗？')){
                ...
                form.action = '/admin/book_lists_f/'+id;
                form.submit();
            }
        }
    </script>
