        ...
        <div class="center">
            <div class="col-main">
                <div class="main-wrap">
                    ...
                    <form class="am-form am-form-horizontal" method="post"action="/home/per_safety/<?php echo e(session('users')->uid); ?>">
                    ...
                    <div class="am-form-group">
                        <label for="user-password" class="am-form-label">默认密码123456</label>
                    </div>
                        <div class="am-form-group">
                            <label for="user-password" class="am-form-label">原支付密码</label>
                            <div class="am-form-content">
                                <input type="password" name="paypass" placeholder="6位数字">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-form-content">
                                <input type="password" name="paypa" placeholder="6位数字">
                            </div>
                        </div>
                        <div class="am-form-group">
                            <label for="user-confirm-password" class="am-form-label">确认密码</label>
                            <div class="am-form-content">
                                <input type="password" name="repaypass" placeholder="请再次输入上面的密码">
                            </div>
                        </div>
                        <div class="info-btn">
