					...
					<div class="user-address">
						...
						<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							...
							<li class="user-addresslist defaultAddr">
								<span class="new-option-r"><i class="am-icon-check-circle"></i><a href="/home/per_add/<?php echo e($v->id); ?>">
									<?php if($v->default == 0): ?>设为默认地址
									<?php endif; ?>
								</a></span>
								...
								<div class="new-mu_l2a new-p-re">
									<p class="new-mu_l2cw">
										...
										<span class="street"><?php echo e($v->address); ?></span></p>
								</div>
								...
								<div class="new-addr-btn">
									<a href="/home/per_address/<?php echo e($v->id); ?>/edit"><i class="am-icon-edit"></i>编辑</a>
									<span class="new-addr-bar">|</span>
									<a href="/home/per_address/<?php echo e($v->id); ?>" onclick="delClick(this);"><i class="am-icon-trash"></i>删除</a>
								</div>
							</li>
