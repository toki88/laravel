...
<!-- 						   		<?php if(session('msg')): ?>
						   		    <h2 class="m-t-0 m-b-15"><?php echo e(session('msg')); ?></h2>
						   		<?php else: ?>
            			...
            			<div class='row'>
            			    <div class='col-xs-4'>
            			        ...
            			        <img src="<?php echo e(url('/Admin/captch/'.time())); ?>" onclick="this.src='<?php echo e(url('/Admin/captch')); ?>/'+Math.random()" style="width:100px;height:25px;"/>
            			   </div>
						</div>
			            <div class="login-links">
								<a href="/home/rpass" class="am-fr">忘记密码</a>
