						...
						<div class="am-modal am-modal-no-btn" id="doc-modal-1">
							...
							<div class="add-dress">
								...
								<div class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
									<form class="am-form am-form-horizontal" action="/home/per_address/<?php echo e($data->id); ?>" method="post">
										<?php echo e(csrf_field()); ?>

										<?php echo e(method_field('PUT')); ?>

										<input type="hidden" name="uid" value="<?php echo e(session('users')->uid); ?>">
										<div class="am-form-group">
											<label for="user-name" class="am-form-label">收货人</label>
											<div class="am-form-content">
												<input type="text" name="consignee" placeholder="<?php echo e($data->consignee); ?>" value="<?php echo e($data->consignee); ?>" disabled>
											</div>
										</div>
										...
										<div class="am-form-group">
											...
											<div class="am-form-content">
												<input name="phone" placeholder="<?php echo e($data->phone); ?>" type="text" value="<?php echo e($data->phone); ?>">
											</div>
										</div>
										<div class="am-form-group">
										...
										<div class="am-form-group">
											...
											<div class="am-form-content">
												<textarea class="" rows="3" name="address" placeholder="<?php echo e($data->address); ?>" value="<?php echo e($data->address); ?>"><?php echo e($data->address); ?></textarea>
