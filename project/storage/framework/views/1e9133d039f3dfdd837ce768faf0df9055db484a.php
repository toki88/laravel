					...
					<div class="m-progress">
						...
						<div class="refund-aside">
							...
							<div class="item-title">
								...
								<div>
									<span><?php echo e($data->check); ?></span>
								</div>
							</div>
							<div class="item-info">
								<div class="item-ordernumber">
									<span class="info-title">订单编号：</span><a><?php echo e($data->loid); ?></a>
								</div>
								<div class="item-price">
									<span class="info-title">价&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格：</span><span class="price"><?php echo e($data->price); ?></span>
									<span class="number">×<?php echo e($data->num); ?></span><span class="item-title">(数量)</span>
								</div>
								<div class="item-amount">
									<span class="info-title">小&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;计：</span><span class="amount"><?php echo e(($data->price)*($data->num)); ?></span>
								</div>
								<div class="item-pay-logis">
									<span class="info-title">运&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;费：</span><span class="price">10.00元</span>
								</div>
								<div class="item-amountall">
									<span class="info-title">总&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;计：</span><span class="amountall"><?php echo e(($data->price)*($data->num)+10); ?></span>
								</div>
								<div class="item-time">
									<span class="info-title">成交时间：</span><span class="time"><?php echo e(date('Y-m-d H:i:s',($data->ltime))); ?></span>
								</div>

							</div>
							<div class="clear"></div>
						</div>
						<form action="/home/per_order/<?php echo e($data->lid); ?>" method="post" enctype='multipart/form-data'>
						...
						<div class="refund-main">
							<div class="item-comment">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input type="text" id="refund-money" readonly="readonly" placeholder="<?php echo e(($data->price)*($data->num)+10); ?>" name="refund_price" value="<?php echo e(($data->price)*($data->num)); ?>">
									</div>
								</div>
								<div class="am-form-group">
