				...
				<div class="main-wrap">
					<div class="user-logistics">
						...
						<div class="package-title">
							<div class="m-item">
								<div class="item-pic">
									<img src="/Admin/upload/<?php echo e($data->pic); ?>" class="itempic J_ItemImg" width="200">
								</div>
								<div class="item-info">
									<p class="log-status">物流状态:<span>
										<?php if(($data->state) == 1): ?>您的宝贝还在途中...
										<?php elseif(($data->state) == 2): ?>已签收
										<?php endif; ?>
									</span> </p>
									<p>承运公司：<?php echo e($data->loname); ?></p>
									<p>快递单号：<?php echo e($data->loid); ?></p>
