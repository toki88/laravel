						...
						<div id="payTable">
												...
												<li class="td td-item">
													<div class="item-pic">
														<a href="/home/goods/{{ $v->gid}}" class="J_MakePoint">
															<img src="/admin/upload/{{ $v->pic }}" class="itempic J_ItemImg"></a>
													</div>
													<div class="item-info">
														<div class="item-basic-info">
															<a href="/home/goods/{{ $v->gid}}" class="item-title J_MakePoint" data-point="tbcart.8.11">{{ $v->name }}</a>
														</div>
													</div>
												</li>
												<li class="td td-info">
													<div class="item-props">
														<span class="sku-line">{{ $v->check }}</span>
													</div>
												</li>
												...
												<div class="amount-wrapper ">
													<div class="item-amount ">
														...
														<div class="sl">
															...
															<span style="width:30px;">{{ $v->num }}</span>
							...
							<div class="buy-point-discharge ">
								<p class="price g_price ">
									合计（含运费） <span>¥</span><em class="pay-sum">{{ $p }}</em>
								</p>
							</div>
							...
							<div class="order-go clearfix">
								<div class="pay-confirm clearfix">
                                    ...
                                    <span>¥</span> <em class="style-large-bold-red " id="J_ActualFee">{{ $p }}</em>
											</span>
										</div>
								   ...
								   <!-- <span class="province">湖北</span>省 -->
									...
									<div id="holyshit269" class="submitOrder">
										<div class="go-btn-wrap">
											<a id="J_Go" href="/home/checkbuy/{{ $lid }}/success" class="btn-go" tabindex="0" title="点击此按钮，提交订单">提交订单</a>
										</div>
									</div>
									<div class="clear"></div>
								</div>
