...
<!-- 								<li class="select-list">
								...
								<li class="select-list">
									<dl id="select2">
										...
										<div class="dd-conent">
											<dd class="select-all selected"><a href="{{ $parent }}">上级</a></dd>
											@foreach($son as $v)
											<dd><a href="{{ $path }},{{ $v->cid }}">{{ $v->name }}</a></dd>
											@endforeach
										</div>
									</dl>
								</li>
<!-- 								<li class="select-list">
							...
							<div class="search-content">
								...
								<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
									...
									<li>
										<a href="/home/goods/{{ $v->gid }}"><div class="i-pic limit">
							...
							<div class="search-side">
								...
								@foreach($list2 as $v)
								<li>
									<div class="i-pic check"><a href="/home/goods/{{ $v->gid}}">
										<img src="/Admin/upload/{{ $v->showpic }}" />
