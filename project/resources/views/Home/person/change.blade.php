									...
									<div class="order-main">
										<div class="order-list">
											<div class="order-title">
												<div class="dd-num">退款编号：<a href="javascript:;">{{ $v->refund_id }}</a></div>
												<span>申请时间：{{ $v->refund_time }}</span>
												<!--    <em>店铺：小桔灯</em>-->
											</div>
													...
													<div class="change move-right">
														<li class="td td-moneystatus td-status">
															<div class="item-status">
																<p class="Mystatus">@if($v->state == 4) 退款中 @elseif($v->state == 5) 退款成功 @endif</p>

															</div>
														</li>
													</div>
													<li class="td td-change td-changebutton">
														<a href="/home/per_record/{{ $v->lid }}">
												...
												<div class="order-left">
													<ul class="item-list">
														...
														<ul class="td-changeorder">
															<li class="td td-orderprice">
																<div class="item-orderprice">
																	<span>交易金额：</span>{{ ($v->price) * ($v->num) }}
																</div>
															</li>
															<li class="td td-changeprice">
																<div class="item-changeprice">
																	<span>退款金额：</span>{{ ($v->price)*($v->num) }}
																</div>
															</li>
														</ul>
														<div class="clear"></div>
