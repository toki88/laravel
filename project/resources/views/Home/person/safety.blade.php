				...
				<div class="main-wrap">
					...
					<div class="user-safety">
						...
						<div class="user-infoPic">
							...
							<div class="info-m">
								<div><b>用户名：<i>{{ session('users')->name }}</i></b></div>
								<div class="u-level">
									<span class="rank r2">
				...
				<ul>
					...
					<li class="person">
						...
						<ul>
							...
							<li class="active"> <a href="/home/per_safety">安全设置</a></li>
