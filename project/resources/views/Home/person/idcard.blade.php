					...
					<form class="am-form am-form-horizontal" method="post"action="/home/per_safety/{{ session('users')->uid }}">
						...
						<div class="am-form-group bind">
							...
							<div class="am-form-content">
								<span name="name">{{ session('users')->name }}</span>
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-name" class="am-form-label">真实姓名</label>
							<div class="am-form-content">
								<input type="text" name="realname" placeholder="请输入您的真实姓名" value="{{ $ob->realname }}"@if($ob->idnum)disabled @endif>
							</div>
						</div>
						<div class="am-form-group">
							<label for="idnum" class="am-form-label">身份证号</label>
							<div class="am-form-content">
								<input type="tel" name="idnum" placeholder="请输入您的身份证信息" value="{{ $ob->idnum }}" @if($ob->idnum)disabled @endif>
							</div>
						</div>
						<div class="info-btn">
