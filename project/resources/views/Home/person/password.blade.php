				...
				<div class="main-wrap">
					...
					<form class="am-form am-form-horizontal" method="post" action="/home/per_safety/{{ session('users')->uid }}">
						...
						<div class="am-form-group">
							...
							<div class="am-form-content">
								<input type="password" name="newpass" placeholder="由数字、字母组合">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">确认密码</label>
							<div class="am-form-content">
								<input type="password" name="repass" placeholder="请再次输入上面的密码">
							</div>
						</div>
						<div class="info-btn">
							<input type="submit" value="保存密码" class="am-btn am-btn-danger">
						</div>
