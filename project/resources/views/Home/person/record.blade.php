					...
					<div class="comment-list">
						...
						<div class="record-aside">
							...
							<div class="item-info">
								...
								<div class="info-little">
									<span>颜色：{{ $data->check }}</span>
									<span>数量：{{ $data->num }}</span>
								</div>
								<div class="item-ordernumber">
									<span class="info-title">退款编号：</span><a>{{ $data->refund_id }}</a>
								</div>
								<div class="item-time">
									<span class="info-title">申请时间：</span><span class="time">{{ date('Y-m-d H:i:s',$data->refund_time) }}</span>
								</div>
						...
						<div class="record-main">
							<div class="detail-list refund-process">
								...
								<div class="money">{{ ($data->num) * ($data->price) }}</div>
							</div>
							<div class="clear"></div>
							<!--进度条-->
