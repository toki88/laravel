								...
								<div class="s-content">
									...
									<div class="s-item-wrap">
										<div class="s-item">
											...
											<div class="s-pic">
												<a href="/home/goods/{{ $v->gid }}" class="s-pic-link">
													<img src="/Admin/upload/{{ $v->showpic }}" alt="{{ $v->gname }}" title="{{ $v->gname }}" class="s-pic-img s-guess-item-img">
												</a>
											</div>
											<div class="s-price-box">
												<span class="s-price"><em class="s-price-sign">¥</em><em class="s-value">{{ ($v->price)+10 }}</em></span>
